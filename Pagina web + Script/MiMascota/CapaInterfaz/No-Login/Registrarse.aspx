<%@ Page Title="" Language="C#" MasterPageFile="~/No-Login/MasterPageNoLogin2.Master" AutoEventWireup="true" CodeBehind="Registrarse.aspx.cs" Inherits="CapaInterfaz.No_Login.Registrarse" %>
...
<h2 class="style1">Registrarse</h2><br />
    ...
    <asp:TextBox ID="txtNombre"
        runat="server" MaxLength="30" ToolTip="Ingrese su primer nombre"></asp:TextBox>
    ...
    <asp:TextBox ID="txtApellido" runat="server" MaxLength="30" 
    ...
    <asp:TextBox ID="txtNombreUsuario" runat="server" MaxLength="100" 
    ...
    <asp:TextBox ID="txtContraseña" runat="server" MaxLength="30" 
